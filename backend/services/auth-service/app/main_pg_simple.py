...
def register(email: str, phone: str, full_name: str, password: str):
    ...
    try:
        ...
        """, (user_id, email, phone, full_name, hashed))
        ...
        # Generate token
        token = create_access_token({"sub": user_id, "email": email, "role": "customer"})
